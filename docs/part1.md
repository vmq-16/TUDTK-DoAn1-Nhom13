...
* **Nghiệm tổng quát:** Đối với trường hợp vô số nghiệm, bắt buộc phải đưa ra công thức nghiệm tổng quát. *(Ví dụ: x1 = 2 - 3t1, x2 = t1)*.
...
4. **Cảnh báo Pivot:** Đưa vào ma trận có phần tử trên đường chéo chính rất nhỏ để kích hoạt cảnh báo *ill-conditioned*.
